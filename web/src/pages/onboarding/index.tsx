...
export const OnboardingPage = () => {
    ...
    return (
        <Card className="rounded-xl shadow-lg w-full max-w-screen-md">
            <form onSubmit={handleSubmit(onSubmit)}>
                <CardHeader className="text-center" floated={false} shadow={false}>
                    <Typography variant="h4" color="blue-gray" className="mb-2">Welcome!</Typography>
                    <Typography variant="small" color="blue-gray">Please fill out the following details to get started.</Typography>
                </CardHeader>
                ...
                <CardBody className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        ...
                        <Input disabled label={!!errors.email ? `Email - ${errors.email.message}` : "Email"} error={!!errors.email} color="green" size="lg" type="email" {...register("email")} />
                        <Input label={!!errors.phone ? `Phone - ${errors.phone.message}` : "Phone"} error={!!errors.phone} color="green" size="lg" {...register("phone")} />
                        <Input label={!!errors.password ? `Password - ${errors.password.message}` : "Password"} error={!!errors.password} color="green" size="lg" type="password" {...register("password")} />
                    </div>
